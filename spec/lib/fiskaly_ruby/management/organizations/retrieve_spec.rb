...
RSpec.describe FiskalyRuby::Management::Organizations::Retrieve do
  ...
  describe '#call' do
    ...
    context 'with valid data' do
      vcr_options = { tag: :fiskaly_service, cassette_name: 'fiskaly_service/kassensichv/organization_retrieve_ok' }
      it 'shows the tss', vcr: vcr_options do
        organization_retrieve = described_class.new(token: token, organization_id: organization_id)
    ...
    context 'with invalid data' do
      ...
      vcr_options = { tag: :fiskaly_service, cassette_name: 'fiskaly_service/kassensichv/organization_retrieve_error' }
      it 'shows the tss', vcr: vcr_options do
        organization_retrieve = described_class.new(token: token, organization_id: organization_id)
