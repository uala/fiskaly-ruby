...
RSpec.describe FiskalyRuby::KassenSichV::TSS::Client::Retrieve do
  ...
  describe '#call' do
    context 'with valid data' do
      ...
      subject(:call) { described_class.new(token: 'some_token', tss_id: tss_id, client_id: client_id).call }

      let(:tss_id) { ENV.fetch('RSPEC_FISKALY_TSS_ID', 'some_tss_id') }
      let(:client_id) { ENV.fetch('RSPEC_FISKALY_TSS_CLIENT_ID', '44bb4b44-b4b4-44b4-4bb4-4bbb4b4bbb44') }
