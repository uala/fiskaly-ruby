...
module FiskalyService
  class BaseRequest
    ...
    #
    # @example
    #   FiskalyService::BaseRequest.new(token: "YOUR_TOKEN")
    #   => #<FiskalyService::BaseRequest:0x0000000131ec5279 @token="YOUR_TOKEN">
    #
    ...
    #
    # @example Call
    #   FiskalyService::BaseRequest.new(token: 'asdf').call
    #   #=> NotImplementedError: FiskalyService::BaseRequest has not implemented method 'call'
    #
    ...
    #   FiskalyService::BaseRequest.new(token: 'asdf').handle(request)
    ...
    #
    # @example Headers
    #   FiskalyService::BaseRequest.new(token: 'asdf').headers
    ...
    #
    # @example Body
    #   FiskalyService::BaseRequest.new(token: 'asdf').body
    #   #=> NotImplementedError: FiskalyService::BaseRequest has not implemented method 'body'
    #
