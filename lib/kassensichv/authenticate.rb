module FiskalyService
  module KassenSichV
    ...
    class Authenticate < Base
      ...
      #
      # @example
      #   FiskalyService::KassenSichV::Authenticate.call(api_key: "YOUR_API_KEY", api_secret: "YOUR_API_SECRET")
      #   => #<FiskalyService::KassenSichV::Authenticate:0x0000000131ec5279 @api_key="YOUR_API_KEY", @api_secret="YOUR_API_SECRET">
      #
      ...
      #
      # @example Body
      #   FiskalyService::KassenSichV::Authenticate.call(api_key: "YOUR_API_KEY", api_secret: "YOUR_API_SECRET").body
