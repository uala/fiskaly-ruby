module FiskalyRuby
  module Management
    ...
    class Authenticate < Base
      ...
      #
      # @example
      #   FiskalyRuby::Management::Authenticate.call(api_key: "YOUR_API_KEY", api_secret: "YOUR_API_SECRET")
      #   => #<FiskalyRuby::Management::Authenticate:0x0000000131ec5279 @api_key="YOUR_API_KEY", @api_secret="YOUR_API_SECRET">
      #
      ...
      #
      # @example Body
      #   FiskalyRuby::Management::Authenticate.call(api_key: "YOUR_API_KEY", api_secret: "YOUR_API_SECRET").body
